...
public class Carrera {
     ...
     */
    public void empezar() {
        Equipo equipoNumero1 = new Equipo("Los Locos de Mosquera", (short) 1);
        Equipo equipoNumero2 = new Equipo("Los Mas rapidos", (short) 2);
        Equipo equipoNumero3 = new Equipo("Casi que no llego", (short) 3);
